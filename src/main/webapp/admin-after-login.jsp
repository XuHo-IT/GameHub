                            ...
                            <div class="header-bar-warp d-flex">
                                ...
                                <nav class="top-nav-area w-100">
                                    <div class="user-panel d-flex">
                                        <div class="account-container">
                                            ...
                                            <div class="account-dropdown">
                                                <ul>
                                                    <li><a href="user-profile.jsp?id=<%= request.getSession().getAttribute("
                                                            adminId")%>">Account Info</a></li>
                                                    <li>
                                    ...
                                    <ul class="main-menu primary-menu">
                                        <li><a href="ReadGameHomeAdminController?adminId=<%= request.getSession().getAttribute("
                                                adminId")%>">Home</a></li>
                                        <li><a href="ReadGameListAdminController?adminId=<%= request.getSession().getAttribute("
                                                adminId")%>">Games</a></li>
                                        <li><a href="ReadTopicAdmin?adminId=<%= request.getSession().getAttribute("
                                                adminId")%>">Forum</a></li>
                                        <li><a href="ReadGameHomeAdmin?view=chart&adminId=<%= request.getSession().getAttribute("
                                                adminId")%>">Manage</a></li>
                    ...
                    <section class="hero-section overflow-hidden">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-9 col-lg-8 col-md-7">
                                        ...
                                        <a href="ReadGameListAdminController?adminId=<%= request.getSession().getAttribute("
                                            adminId")%>" class="more-game-btn">More Game</a>
                                    </div>
                                        ...
                                        <div id="stickySidebar">
                                            ...
                                            <div class="widget-item">
                                                <div class="categories-widget">
                                                    ...
                                                    <form
                                                        action="ReadGameHomeAdminController?adminId=<%= request.getSession().getAttribute("
                                                        adminId")%>" method="get">
                                                        <ul>
                                                            <c:forEach var="genre" items="${genres}">
                                                                <li>
                                                                    <a href="ReadGameHomeAdminController?genre=${genre.genre}&adminId=<%= request.getSession().getAttribute("
                                                                        adminId")%>">
                        ...
                        <footer class="footer-section">
                            <div class="container">
                                ...
                                <a href="ReadGameHomeAdminController?adminId=<%= request.getSession().getAttribute("
                                    adminId")%>" class="footer-logo">
                                    ...
                                    <form action="AddGameController" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="input-field">
                                            ...
                                            <select name="Genre" required>
                                                ...
                                                <c:forEach var="genre" items="${genres}">
                                                    <option value="${genre.genre}">${genre.genre != null ? genre.genre :
                                                        'No genre available'}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="input-field">
