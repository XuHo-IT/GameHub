        ...
        <div class="form-box login">
            ...
            <div class="form-content">
                ...
                <form action="LoginController" method="post">
                    ...
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/GoogleLoginController&response_type=code
		   &client_id=1057176700449-80af0i8rm46jtve115vp3jpv88r2mt7b.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
