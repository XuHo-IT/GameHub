...
<head>
    ...
    <style>
      /* Adding some CSS for proper layout */
      html, body {
          height: 100%;
          margin: 0;
          padding: 0;
                  ...
                  <form class="form" novalidate="">
                    ...
                    <div class="row">
                      <div class="col-12 col-sm-6 mb-3">
                        <div class="mb-2" style="color: antiquewhite;"><b>Change Password</b></div>
                        <div class="row">
                          <div class="col">
                            <div class="form-group" style="color: antiquewhite;">
                      ...
                      <div class="col-12 col-sm-5 offset-sm-1 mb-3">
                        <div class="mb-2" style="color: antiquewhite;"><b>Keeping in Touch</b></div>
                        <div class="row">
