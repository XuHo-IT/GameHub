...
<body>
    ...
    <!-- Intro section -->
   <section class="intro-video-section set-bg d-flex align-items-end" data-setbg="./img/image.gif">
    <div class="video-container">
        <!-- Replace the video with an img tag for the GIF -->
    ...
    <div class="form-popup">
        ...
        <div class="form-box login">
            ...
            <div class="form-content">
                ...
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/Web_Trading_Game/GoogleLoginController&response_type=code&client_id=1057176700449-80af0i8rm46jtve115vp3jpv88r2mt7b.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
